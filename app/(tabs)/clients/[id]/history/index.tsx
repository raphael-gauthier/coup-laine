...
export default function ClientHistoryScreen() {
  ...
  const { data: entries = [], isError, isLoading, refetch } = useClientHistory(id);
  ...
  return (
    <Surface className="flex-1">
      ...
      {isLoading ? (
        ...
        <EmptyState
          icon={<HistoryIcon size={48} color={mutedFg} />}
      ...
      <Fab
        icon={Plus}
        onPress={() => router.push(`/(tabs)/clients/${id}/history/new` as never)}
